...
@section('title', __('BatuBeling Express | Masuk'))
...
<form method="POST" action="{{ route('login') }}" class="needs-validation">
    ...
    <div class="form-group">
        <div class="custom-control custom-checkbox">
            <input type="checkbox" class="custom-control-input" tabindex="3" name="remember" id="remember"
    ...
    <div class="form-group">
        ...
        <a class="btn btn-primary btn-lg btn-block" tabindex="4" href="{{ route('password.request') }}">
